...
class ObjectDetection {
    ...
    public void run(String[] args) {
        String filenameFaceCascade = this.getClass().getResource("/haarcascades/haarcascade_frontalface_alt.xml").getFile();
        String filenameEyesCascade = this.getClass().getResource("/haarcascades/haarcascade_eye_tree_eyeglasses.xml").getFile();
