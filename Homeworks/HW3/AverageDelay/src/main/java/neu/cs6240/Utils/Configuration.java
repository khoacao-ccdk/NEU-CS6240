...
public class Configuration {
  ...
  public static final int INTERVAL_START_MONTH = 12;
  public static final int INTERVAL_END_YEAR = 2008;
  public static final int INTERVAL_END_MONTH = 1;
  public static final String EXPECTED_CANCELLED_STATUS = "0";
  public static final String EXPECTED_DIVERTED_STATUS = "0";
}
